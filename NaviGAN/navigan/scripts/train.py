...
from sgan.losses import gan_g_loss, gan_d_loss, l2_loss, l1_loss
...
def generator_step(
    ...
    if args.intention_loss_type == 'smoothl1':
        ...
        intention_loss = args.pred_len*final_displacement_error(intention_traj[-1], pred_traj_gt[-1], mode='raw')
